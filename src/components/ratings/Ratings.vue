<template>
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <split></split>
      <rating-select :select-type="selectType" :only-content="onlyContent" :ratings="ratings" v-on:selectRatingType="selectRatingType" v-on:toggle="toggleContent"></rating-select>
