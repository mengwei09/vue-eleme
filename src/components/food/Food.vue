    ...
    <div class="food" v-show="showFlag" ref="food">
      <div class="food-content">
        ...
        <div class="ratings">
          ...
          <rating-select :select-type="selectType" :only-content="onlyContent" :desc="desc" :ratings="food.ratings" v-on:selectRatingType="selectRatingType" v-on:toggle="toggleContent"></rating-select>
